...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        controlPanel.setLayout(new FormLayout("fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:d:grow,left:4dlu:noGrow,fill:d:grow,left:10dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:d:grow,fill:5dlu:noGrow,fill:max(d;4px):noGrow", "center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,center:8dlu:noGrow,center:8dlu:noGrow,top:14dlu:noGrow,center:27px:noGrow,center:8dlu:noGrow,center:max(d;4px):noGrow,center:8dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:6dlu:noGrow,center:6dlu:noGrow,top:14dlu:noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:8dlu:noGrow,center:8dlu:noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,center:max(d;4px):noGrow,center:6dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:8dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow"));
        ...
        controlPanel.add(textSpinnerY, cc.xy(9, 20, CellConstraints.FILL, CellConstraints.DEFAULT));
        ...
        checkBox1.setText("");
        controlPanel.add(checkBox1, cc.xy(9, 6, CellConstraints.RIGHT, CellConstraints.CENTER));
        ...
        checkBox3.setText("");
        controlPanel.add(checkBox3, cc.xy(9, 24, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        checkBox2 = new JCheckBox();
        checkBox2.setText("");
        controlPanel.add(checkBox2, cc.xy(9, 16, CellConstraints.RIGHT, CellConstraints.CENTER));
